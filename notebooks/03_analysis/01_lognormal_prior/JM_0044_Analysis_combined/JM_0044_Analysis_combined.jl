...
pooled_dc3_results_notebooks = filter(x -> !isnothing(match(r"JM_00((3[6,7])|(4[0,1]))",x)),readdir(projectdir("notebooks", "02_fitting","01_lognormal_prior"), join=true))

# ╔═╡ 8691540d-c347-4fff-914b-00cea31dc22c
nonpooled_dc3_results_notebooks = filter(x -> !isnothing(match(r"JM_003[4,5,8,9]",x)),readdir(projectdir("notebooks", "02_fitting","01_lognormal_prior"), join=true))
