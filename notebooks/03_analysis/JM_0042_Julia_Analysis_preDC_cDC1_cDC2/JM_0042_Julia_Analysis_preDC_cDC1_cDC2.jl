...
begin
	...
	# 		groupedboxplot(_.model_id, _.p_DC2bm, group=_.donor, outliers=false),
	# 		title=["p ASDC" "p cDC1" "p DC2"],
	...
	# 		groupedboxplot(_.model_id, _.dwell_DC2_bm, group=_.donor, outliers=false),
	...
	# 		groupedboxplot(_.model_id, _.dwell_DC2_b, group=_.donor, outliers=false),
	# 		title=["dwell_ASDC_bm" "dwell_cDC1_bm" "dwell_DC2_bm" "dwell_ASDC_b" "dwell_cDC1_b" "dwell_DC2_b"],
	# 		legend=:outertopright,
	# 		layout=(3,2),
	# 		size=(600,900),
	# 		xaxis=45,
	...
	# 		groupedviolin(_.model_id, _.p_DC2bm, group=_.donor .* "_" .* _.prior, outliers=false),
	# 		title=["p ASDC" "p cDC1" "p DC2"],
	# 		layout=(3,1),
	# 		size=(600,900),
	# 		xaxis=45,
...
begin
	...
	# subset(_, :model_id => (x -> x .!= "4")) |>
	# subset(_, :model_type => ((x) -> x .∈ Ref(["pooled"]))) |>
	# select(_, [:model_id,:model_type,:donor,:p_ASDCbm, :p_cDC1bm, :p_DC2bm]) |>
	# groupby(_, [:model_id, :model_type, :donor]) |>
	# combine(_, [:p_ASDCbm, :p_cDC1bm, :p_DC2bm] .=> (x -> [[mean(x), tuple([abs.(MCMCChains._hpd(x; alpha=0.2).-mean(x))...]...)]]) .=> [:p_ASDCbm, :p_cDC1bm, :p_DC2bm]) |>
	# begin
	# 	plot(
	...
	# 		scatter(map(x -> x[1],_.p_DC2bm), _.model_id .* "_" .* _.model_type, xerror = map(x -> x[2],_.p_DC2bm), group=_.donor, lab="mean"),
	# 		title=["p ASDC" "p cDC1" "p DC2"],
	# 		legend=:outertopright,
	# 		layout=(3,1),
	# 		size=(300,900),
	...
	# 		scatter(map(x -> x[1],_.p_DC2bm), _.model_id .* "_" .* _.model_type .* "_" .* _.donor, xerror = map(x -> x[2],_.p_DC2bm), lab="mean"),
	# 		title=["p ASDC" "p cDC1" "p DC2"],
	# 		legend=:outertopright,
	# 		layout=(3,1),
	# 		size=(300,900),
	...
	# subset(_, :model_id => (x -> x .!= "4")) |>
	# subset(_, :model_type => ((x) -> x .∈ Ref(["pooled"]))) |>
	# select(_, [:model_id,:model_type,:donor,:dwell_ASDC_bm,:dwell_cDC1_bm,:dwell_DC2_bm,:dwell_ASDC_b,:dwell_cDC1_b,:dwell_DC2_b]) |>
	# groupby(_, [:model_id, :model_type, :donor]) |>
	# combine(_, [:dwell_ASDC_bm,:dwell_cDC1_bm,:dwell_DC2_bm,:dwell_ASDC_b,:dwell_cDC1_b,:dwell_DC2_b] .=> (x -> [[mean(x), tuple([abs.(MCMCChains._hpd(x; alpha=0.2).-mean(x))...]...)]]) .=> [:dwell_ASDC_bm,:dwell_cDC1_bm,:dwell_DC2_bm,:dwell_ASDC_b,:dwell_cDC1_b,:dwell_DC2_b]) |>
	# begin
	# 	plot(
	...
	# 		scatter(map(x -> x[1], _.dwell_DC2_bm), _.model_id .* "_" .* _.model_type,xerror= map(x -> x[2], _.dwell_DC2_bm), group=_.donor, lab="mean"),
	...
	# 		scatter(map(x -> x[1],_.dwell_DC2_b), _.model_id .* "_" .* _.model_type, xerror = map(x -> x[2],_.dwell_DC2_b), group=_.donor, lab="mean"),
	# 		title=["dwell_ASDC_bm" "dwell_cDC1_bm" "dwell_DC2_bm" "dwell_ASDC_b" "dwell_cDC1_b" "dwell_DC2_b"],
	# 		legend=:outertopright,
	# 		layout=(3,2),
	# 		size=(600,900),
	...
	# 		scatter(map(x -> x[1], _.dwell_DC2_bm), _.model_id .* "_" .* _.model_type .* "_" .* _.donor,xerror= map(x -> x[2], _.dwell_DC2_bm), lab="mean"),
	...
	# 		scatter(map(x -> x[1],_.dwell_DC2_b), _.model_id .* "_" .* _.model_type .* "_" .* _.donor, xerror = map(x -> x[2],_.dwell_DC2_b), lab="mean"),
	# 		title=["dwell_ASDC_bm" "dwell_cDC1_bm" "dwell_DC2_bm" "dwell_ASDC_b" "dwell_cDC1_b" "dwell_DC2_b"],
	# 		legend=:outertopright,
	# 		layout=(3,2),
	# 		size=(600,900),
	...
	# select(_, [:model_id,:model_type,:donor,:p_ASDCbm, :p_cDC1bm, :p_DC2bm]) |>
	# groupby(_, [:model_id, :model_type, :donor]) |>
	# combine(_, [:p_ASDCbm, :p_cDC1bm, :p_DC2bm] .=> (x -> [[mean(x), [MCMCChains._hpd(x; alpha=0.2)...]...]]) .=> [:p_ASDCbm, :p_cDC1bm, :p_DC2bm]) |>
	# DataFrames.stack(_, [:p_ASDCbm, :p_cDC1bm, :p_DC2bm]) |>
	# transform(_, :value => ByRow(x -> (mean=x[1], ci_80_l = x[2], ci_80_u=x[3])) => AsTable)|>
	# select(_, Not(:value)) |> 
	# sort(_, :model_id) |>
	# transform(_,:model_id => (x -> tryparse.(Int,x) ), renamecols=false)|>
