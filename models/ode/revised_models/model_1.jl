function _model_1(du,u,p,t, U_func, R)
    ...
    p_preDCbm, δ_preDCbm, p_cDC1bm, δ_cDC1bm, p_cDC2bm, δ_cDC2bm, δ_preDCb, δ_cDC1b, δ_cDC2b, λ_preDC, λ_cDC1, λ_cDC2, Δ_cDC1bm, Δ_cDC2bm, Δ_cDC1b, Δ_cDC2b = p[1:(end-4)]
    ...
    du[5] = λ_cDC1 * R_cDC1 * LcDC1m + Δ_cDC1b * R_precDC1b * LpreDCb - δ_cDC1b*LcDC1b ##cDC1b
