...
function Base.rand(d::MyDistribution)
    ...
    b[4] = rand(truncated(d.dδ_preDCb,0.0, b[1]*d.RpreDC)) #δ_preDCb
...
function Distributions._rand!(rng::Random.AbstractRNG,d::MyDistribution, x::Array{Float64,1})
    ...
    x[4] = rand(truncated(d.dδ_preDCb,0.0, x[1]*d.RpreDC)) #δ_preDCb
...
function Distributions._logpdf(d::MyDistribution, b::AbstractVector)
    ...
    l += logpdf(truncated(d.dδ_preDCb,0.0, b[1]*d.RpreDC), b[4]) #δ_preDCb
...
function (b::MyBijector)(x::AbstractVector)
    ...
    y[4] = bijector(truncated(b.dδ_preDCb,0.0,  x[1]*b.RpreDC))(x[4]) #δ_preDCb
...
function (b::Inverse{<:MyBijector})(y::AbstractVector)
    ...
    x[4] = inv(bijector(truncated(b.orig.dδ_preDCb,0.0, x[1]*b.orig.RpreDC)))(y[4]) #δ_preDCb
...
function Bijectors.logabsdetjac(b::MyBijector, x::AbstractVector)
    ...
    l += logabsdetjac(bijector(truncated(b.dδ_preDCb,0.0,  x[1]*b.RpreDC)),x[4]) #δ_preDCb
...
Bijectors.bijector(d::MyDistribution)= MyBijector(d.dp_preDCbm,d.dp_cDC1bm,d.dp_cDC2bm,d.dδ_preDCb,d.dλ_cDC1,d.dλ_cDC2,d.RpreDC,d.RpreDC_cDC1_bm,d.RpreDC_cDC2_bm)
...
@model function _turing_model(data::NamedTuple, ode_prob::ODEProblem, solver, priors::NamedTuple, sim::Bool=false, logp::Bool=false; ode_args = (;))
	### priors
    par ~ MyDistribution(priors.p_preDCbm, priors.p_cDC1bm, priors.p_cDC2bm, Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0),data.R.RpreDC, data.R.RpreDC_cDC1_bm,data.R.RpreDC_cDC2_bm)
    p_preDCbm, p_cDC1bm, p_cDC2bm, δ_preDCb, λ_cDC1, λ_cDC2 = par           
    λ_preDC = δ_preDCb / data.R.RpreDC
