...
function Base.rand(d::MyDistribution)
    ...
    b[10] = rand(truncated(d.dΔ_DC2b,0.0, -3e-12 + (b[1] - b[7] -b[8]-b[9]/d.RASDC)*d.RASDC)) #Δ_DC2b
...
function Distributions._rand!(rng::Random.AbstractRNG,d::MyDistribution, x::Array{Float64,1})
    ...
    x[10] = rand(truncated(d.dΔ_DC2b,0.0, -3e-12 + (x[1] - x[7] -x[8]-x[9]/d.RASDC)*d.RASDC)) #Δ_DC2b
...
function Distributions._logpdf(d::MyDistribution, b::AbstractVector)
    ...
    l += logpdf(truncated(d.dΔ_DC2b,0.0, -3e-12 + (b[1] - b[7] -b[8]-b[9]/d.RASDC)*d.RASDC), b[10]) #Δ_DC2b
...
function (b::MyBijector)(x::AbstractVector)
    ...
    y[10] = bijector(truncated(b.dΔ_DC2b,0.0, -3e-12 + (x[1] - x[7] -x[8]-x[9]/b.RASDC)*b.RASDC))(x[10]) #Δ_DC2b
...
function Bijectors.logabsdetjac(b::MyBijector, x::AbstractVector)
    ...
    l += logabsdetjac(bijector(truncated(b.dΔ_DC2b,0.0, -3e-12 + (x[1] - x[7] -x[8]-x[9]/b.RASDC)*b.RASDC)),x[10]) #Δ_DC2b
...
@model function _turing_model(data::Array{Float64,1}, metadata::NamedTuple, ode_prob::ODEProblem, solver, ode_parallel_mode=EnsembleSerial(), priors::NamedTuple; ode_args = (;))
	### priors
    par ~ MyDistribution(priors.p_ASDCbm, priors.p_cDC1bm, priors.p_DC2bm, Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0),metadata.R.RASDC, metadata.R.RASDC_cDC1_bm,metadata.R.RASDC_DC2_bm)
