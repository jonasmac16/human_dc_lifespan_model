...
function Base.rand(d::MyDistribution)
    ...
    b[8] = rand(truncated(d.dΔ_cDC2b,0.0, -5e-12 + (b[1] - b[7])*d.R_preDC)) #Δ_cDC2b
    b[4] = rand(truncated(d.dδ_preDCb,0.0, -4e-12 +  (b[1] - b[7] -b[8]/d.R_preDC)*d.R_preDC)) #δ_preDCb
...
function Distributions._rand!(rng::Random.AbstractRNG,d::MyDistribution, x::Array{Float64,1})
    ...
    x[8] = rand(truncated(d.dΔ_cDC2b,0.0, -5e-12 + (x[1] - x[7])*d.R_preDC)) #Δ_cDC2b
    x[4] = rand(truncated(d.dδ_preDCb,0.0, -4e-12 +  (x[1] - x[7] -x[8]/d.R_preDC)*d.R_preDC)) #δ_preDCb
...
function Distributions._logpdf(d::MyDistribution, b::AbstractVector)
    ...
    l += logpdf(truncated(d.dΔ_cDC2b,0.0, -5e-12 + (b[1] - b[7])*d.R_preDC), b[8]) #Δ_cDC2b
    l += logpdf(truncated(d.dδ_preDCb,0.0, -4e-12 +  (b[1] - b[7] -b[8]/d.R_preDC)*d.R_preDC), b[4]) #δ_preDCb
...
function (b::MyBijector)(x::AbstractVector)
    ...
    y[8] = bijector(truncated(b.dΔ_cDC2b,0.0, -5e-12 + (x[1] - x[7])*b.R_preDC))(x[8]) #Δ_cDC2b
    y[4] = bijector(truncated(b.dδ_preDCb,0.0,  -4e-12 + (x[1] - x[7] -x[8]/b.R_preDC)*b.R_preDC))(x[4]) #δ_preDCb
...
function (b::Inverse{<:MyBijector})(y::AbstractVector)
    ...
    x[8] = inv(bijector(truncated(b.orig.dΔ_cDC2b,0.0, -5e-12 + (x[1] - x[7])*b.orig.R_preDC)))(y[8]) #Δ_cDC2b
    x[4] = inv(bijector(truncated(b.orig.dδ_preDCb,0.0, -4e-12 +  (x[1] - x[7] -x[8]/b.orig.R_preDC)*b.orig.R_preDC)))(y[4]) #δ_preDCb
...
function Bijectors.logabsdetjac(b::MyBijector, x::AbstractVector)
    ...
    l += logabsdetjac(bijector(truncated(b.dΔ_cDC2b,0.0, -5e-12 + (x[1] - x[7])*b.R_preDC)),x[8]) #Δ_cDC2b
    l += logabsdetjac(bijector(truncated(b.dδ_preDCb,0.0,  -4e-12 + (x[1] - x[7] -x[8]/b.R_preDC)*b.R_preDC)),x[4]) #δ_preDCb
...
Bijectors.bijector(d::MyDistribution)= MyBijector(d.dp_preDCbm,d.dp_cDC1bm,d.dp_cDC2bm,d.dδ_preDCb,d.dΔ_cDC2bm,d.dΔ_cDC2b,d.dλ_cDC1,d.dλ_cDC2,d.R_preDC,d.R_precDC1bm,d.R_precDC2bm)
...
@model function _turing_model(data::Array{Float64,1}, metadata::NamedTuple, ode_prob::ODEProblem, solver, priors::NamedTuple; ode_parallel_mode=EnsembleSerial(), ode_args = (;))
    ...
    p_preDCbm, p_cDC1bm, p_cDC2bm, δ_preDCb, λ_cDC1, λ_cDC2, Δ_cDC2bm, Δ_cDC2b = par           
    λ_preDC = (Δ_cDC2b + δ_preDCb) / R_preDC
    ...
    theta = [[p_preDCbm, δ_preDCbm, p_cDC1bm, δ_cDC1bm, p_cDC2bm, δ_cDC2bm, δ_preDCb, δ_cDC1b, δ_cDC2b, λ_preDC, λ_cDC1, λ_cDC2, Δ_cDC2bm, Δ_cDC2b] for j in 1:metadata.n_indv]
    ...
    parameters =(;p_preDCbm=p_preDCbm, δ_preDCbm=δ_preDCbm, p_cDC1bm=p_cDC1bm, δ_cDC1bm=δ_cDC1bm, p_cDC2bm=p_cDC2bm, δ_cDC2bm=δ_cDC2bm, δ_preDCb=δ_preDCb, δ_cDC1b=δ_cDC1b, δ_cDC2b=δ_cDC2b, λ_preDC=λ_preDC, λ_cDC1=λ_cDC1, λ_cDC2=λ_cDC2, Δ_cDC2bm=Δ_cDC2bm, Δ_cDC2b=Δ_cDC2b))
end
