...
function Base.rand(d::MyDistribution)
    ...
    b[8] = rand(truncated(d.dΔ_DC2b,0.0, -3e-12 + (b[1] - b[5] -b[6]-b[7]/d.RASDC)*d.RASDC)) #Δ_DC2b
...
function Distributions._rand!(rng::Random.AbstractRNG,d::MyDistribution, x::Array{Float64,1})
    ...
    x[8] = rand(truncated(d.dΔ_DC2b,0.0, -3e-12 + (x[1] - x[5] -x[6]-x[7]/d.RASDC)*d.RASDC)) #Δ_DC2b
...
function Distributions._logpdf(d::MyDistribution, b::AbstractVector)
    ...
    l += logpdf(truncated(d.dΔ_DC2b,0.0, -3e-12 + (b[1] - b[5] -b[6]-b[7]/d.RASDC)*d.RASDC), b[8]) #Δ_DC2b
...
function (b::MyBijector)(x::AbstractVector)
    ...
    y[8] = bijector(truncated(b.dΔ_DC2b,0.0, -3e-12 + (x[1] - x[5] -x[6]-x[7]/b.RASDC)*b.RASDC))(x[8]) #Δ_DC2b
...
function (b::Inverse{<:MyBijector})(y::AbstractVector)
    ...
    x[8] = inv(bijector(truncated(b.orig.dΔ_DC2b,0.0, -3e-12 + (x[1] - x[5] -x[6]-x[7]/b.orig.RASDC)*b.orig.RASDC)))(y[8]) #Δ_DC2b
...
function Bijectors.logabsdetjac(b::MyBijector, x::AbstractVector)
    ...
    l += logabsdetjac(bijector(truncated(b.dΔ_DC2b,0.0, -3e-12 + (x[1] - x[5] -x[6]-x[7]/b.RASDC)*b.RASDC)),x[8]) #Δ_DC2b
    l += logabsdetjac(bijector(truncated(b.dδ_ASDCb,0.0,  -2e-12 + (x[1] - x[5] -x[6]-x[7]/b.RASDC-x[8]/b.RASDC)*b.RASDC)),x[4]) #δ_ASDCb

    return l
end
Bijectors.bijector(d::MyDistribution)= MyBijector(d.dp_ASDCbm,d.dp_cDC1bm,d.dp_DC2bm,d.dδ_ASDCb,d.dΔ_cDC1bm,d.dΔ_DC2bm,d.dΔ_cDC1b,d.dΔ_DC2b,d.RASDC,d.RASDC_cDC1_bm,d.RASDC_DC2_bm)
...
@model function _turing_model(data::NamedTuple, ode_prob::ODEProblem, solver, priors::NamedTuple, sim::Bool=false, logp::Bool=false; ode_args = (;))
    ...
    λ_ASDC = (Δ_cDC1b + Δ_DC2b + δ_ASDCb) / data.R.RASDC
    ...
    δ_DC2bm = p_DC2bm .+ Δ_DC2bm .* data.R.RASDC_DC2_bm
    δ_cDC1b = Δ_cDC1b .* data.R.RASDC_cDC1_blood
    δ_DC2b = Δ_DC2b .* data.R.RASDC_DC2_blood
