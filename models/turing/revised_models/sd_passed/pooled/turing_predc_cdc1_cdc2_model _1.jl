...
function Base.rand(d::MyDistribution)
    ...
    b[9] = rand(truncated(d.dΔ_cDC1b,0.0, -4e-12 + (b[1] - b[7] -b[8])*d.RASDC)) #Δ_cDC1b
    b[10] = rand(truncated(d.dΔ_cDC2b,0.0, -3e-12 + (b[1] - b[7] -b[8]-b[9]/d.RASDC)*d.RASDC)) #Δ_cDC2b
    b[4] = rand(truncated(d.dδ_ASDCb,0.0, -2e-12 +  (b[1] - b[7] -b[8]-b[9]/d.RASDC-b[10]/d.RASDC)*d.RASDC)) #δ_ASDCb
    
    
    upper_λ_cDC1 = b[2] + b[7] * d.RASDC_cDC1_bm
    upper_λ_cDC2 = b[3] + b[8] * d.RASDC_cDC2_bm
...
function Distributions._rand!(rng::Random.AbstractRNG,d::MyDistribution, x::Array{Float64,1})
    ...
    x[9] = rand(truncated(d.dΔ_cDC1b,0.0, -4e-12 + (x[1] - x[7] -x[8])*d.RASDC)) #Δ_cDC1b
    x[10] = rand(truncated(d.dΔ_cDC2b,0.0, -3e-12 + (x[1] - x[7] -x[8]-x[9]/d.RASDC)*d.RASDC)) #Δ_cDC2b
    x[4] = rand(truncated(d.dδ_ASDCb,0.0, -2e-12 +  (x[1] - x[7] -x[8]-x[9]/d.RASDC-x[10]/d.RASDC)*d.RASDC)) #δ_ASDCb
    
    
    upper_λ_cDC1 = x[2] + x[7] * d.RASDC_cDC1_bm
    upper_λ_cDC2 = x[3] + x[8] * d.RASDC_cDC2_bm
...
function Distributions._logpdf(d::MyDistribution, b::AbstractVector)
    ...
    l += logpdf(truncated(d.dΔ_cDC1b,0.0, -4e-12 + (b[1] - b[7] -b[8])*d.RASDC), b[9]) #Δ_cDC1b
    l += logpdf(truncated(d.dΔ_cDC2b,0.0, -3e-12 + (b[1] - b[7] -b[8]-b[9]/d.RASDC)*d.RASDC), b[10]) #Δ_cDC2b
    l += logpdf(truncated(d.dδ_ASDCb,0.0, -2e-12 +  (b[1] - b[7] -b[8]-b[9]/d.RASDC-b[10]/d.RASDC)*d.RASDC), b[4]) #δ_ASDCb
...
function (b::MyBijector)(x::AbstractVector)
    ...
    y[9] = bijector(truncated(b.dΔ_cDC1b,0.0, -4e-12 + (x[1] - x[7] -x[8])*b.RASDC))(x[9]) #Δ_cDC1b
    y[10] = bijector(truncated(b.dΔ_cDC2b,0.0, -3e-12 + (x[1] - x[7] -x[8]-x[9]/b.RASDC)*b.RASDC))(x[10]) #Δ_cDC2b
    y[4] = bijector(truncated(b.dδ_ASDCb,0.0,  -2e-12 + (x[1] - x[7] -x[8]-x[9]/b.RASDC-x[10]/b.RASDC)*b.RASDC))(x[4]) #δ_ASDCb
    
    
    upper_λ_cDC1 = x[2] + x[7] * b.RASDC_cDC1_bm
    upper_λ_cDC2 = x[3] + x[8] * b.RASDC_cDC2_bm
...
function (b::Inverse{<:MyBijector})(y::AbstractVector)
    ...
    x[10] = inv(bijector(truncated(b.orig.dΔ_cDC2b,0.0, -3e-12 + (x[1] - x[7] -x[8]-x[9]/b.orig.RASDC)*b.orig.RASDC)))(y[10]) #Δ_cDC2b
    ...
    upper_λ_cDC2 = x[3] + x[8] * b.orig.RASDC_cDC2_bm
...
function Bijectors.logabsdetjac(b::MyBijector, x::AbstractVector)
    ...
    l += logabsdetjac(bijector(truncated(b.dΔ_cDC1b,0.0, -4e-12 + (x[1] - x[7] -x[8])*b.RASDC)),x[9]) #Δ_cDC1b
    l += logabsdetjac(bijector(truncated(b.dΔ_cDC2b,0.0, -3e-12 + (x[1] - x[7] -x[8]-x[9]/b.RASDC)*b.RASDC)),x[10]) #Δ_cDC2b
    l += logabsdetjac(bijector(truncated(b.dδ_ASDCb,0.0,  -2e-12 + (x[1] - x[7] -x[8]-x[9]/b.RASDC-x[10]/b.RASDC)*b.RASDC)),x[4]) #δ_ASDCb
...
Bijectors.bijector(d::MyDistribution)= MyBijector(d.dp_ASDCbm,d.dp_cDC1bm,d.dp_cDC2bm,d.dδ_ASDCb,d.dΔ_cDC1bm,d.dΔ_cDC2bm,d.dΔ_cDC1b,d.dΔ_cDC2b,d.dλ_cDC1,d.dλ_cDC2,d.RASDC,d.RASDC_cDC1_bm,d.RASDC_cDC2_bm)
...
@model function _turing_model(data::Array{Float64,1}, metadata::NamedTuple, ode_prob::ODEProblem, solver, ode_parallel_mode=EnsembleSerial(), priors::NamedTuple; ode_args = (;))
	### priors
    par ~ MyDistribution(priors.p_ASDCbm, priors.p_cDC1bm, priors.p_cDC2bm, Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0),metadata.R.RASDC, metadata.R.RASDC_cDC1_bm,metadata.R.RASDC_cDC2_bm)
    p_ASDCbm, p_cDC1bm, p_cDC2bm, δ_ASDCb, λ_cDC1, λ_cDC2, Δ_cDC1bm, Δ_cDC2bm, Δ_cDC1b, Δ_cDC2b = par
    λ_ASDC = (Δ_cDC1b + Δ_cDC2b + δ_ASDCb) / metadata.R.RASDC
    ...
    δ_cDC2bm = p_cDC2bm .+ Δ_cDC2bm .* metadata.R.RASDC_cDC2_bm .- λ_cDC2
    δ_cDC1b = λ_cDC1 .* metadata.R.RcDC1 .+ Δ_cDC1b .* metadata.R.RASDC_cDC1_blood
    δ_cDC2b = λ_cDC2 .* metadata.R.RcDC2 .+ Δ_cDC2b .* metadata.R.RASDC_cDC2_blood

    ## parameter vector
    theta = [[p_ASDCbm, δ_ASDCbm, p_cDC1bm, δ_cDC1bm, p_cDC2bm, δ_cDC2bm, δ_ASDCb, δ_cDC1b, δ_cDC2b, λ_ASDC, λ_cDC1, λ_cDC2, Δ_cDC1bm, Δ_cDC2bm, Δ_cDC1b, Δ_cDC2b] for j in 1:metadata.n_indv]
