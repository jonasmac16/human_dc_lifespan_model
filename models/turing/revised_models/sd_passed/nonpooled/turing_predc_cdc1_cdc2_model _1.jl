...
@model function _turing_model(data::Array{Float64,1}, metadata::NamedTuple, ode_prob::ODEProblem, solver, ode_parallel_mode=EnsembleSerial(), priors::NamedTuple; ode_args = (;))
	### priors
    par ~ filldist(MyDistribution(priors.p_preDCbm, priors.p_cDC1bm, priors.p_cDC2bm, Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0),metadata.R.RpreDC, metadata.R.RpreDC_cDC1_bm,metadata.R.RpreDC_cDC2_bm),metadata.n_indv)
    
    p_preDCbm, p_cDC1bm, p_cDC2bm, δ_preDCb, λ_cDC1, λ_cDC2, Δ_cDC1bm, Δ_cDC2bm, Δ_cDC1b, Δ_cDC2b = eachrow(par)
