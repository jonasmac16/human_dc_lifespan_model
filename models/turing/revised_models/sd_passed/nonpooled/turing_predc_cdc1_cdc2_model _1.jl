...
@model function _turing_model(data::Array{Float64,1}, metadata::NamedTuple, ode_prob::ODEProblem, solver, ode_parallel_mode=EnsembleSerial(), priors::NamedTuple; ode_args = (;))
	### priors
    par ~ filldist(MyDistribution(priors.p_ASDCbm, priors.p_cDC1bm, priors.p_cDC2bm, Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0), Uniform(0.0,2.0),metadata.R.RASDC, metadata.R.RASDC_cDC1_bm,metadata.R.RASDC_cDC2_bm),metadata.n_indv)
    
    p_ASDCbm, p_cDC1bm, p_cDC2bm, δ_ASDCb, λ_cDC1, λ_cDC2, Δ_cDC1bm, Δ_cDC2bm, Δ_cDC1b, Δ_cDC2b = eachrow(par)
